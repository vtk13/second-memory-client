...
class ItemWorkspace extends React.Component{
    ...
    render(){
        ...
        if (item) {
            ...
            let text = `<p>Подбел растягивает подбел. Желтозём нагревает разрез. Кутана методологически эволюционирует в удельный денситомер. Вскипание с HCl, несмотря на внешние воздействия, ускоряет ламинарный лёсс. С учетом всех вышеизложенных обстоятельств, можно считать допустимым, что возмущение плотности дает зоогенный монолит. Явление дает многофазный уровень грунтовых вод, и этот процесс может повторяться многократно.</p>
